...
import "./BelowHeaderLeft.css";
import { Container, Col, Row, Button } from "react-bootstrap";


const BelowHeaderLeft = () => {

  
  return (
    <>
   <Button  className="tag-button d-block d-md-none">Show More <i style={{fontSize:"13px"}} className="bi bi-chevron-compact-down"></i></Button>
    ...
    <Button className="tag-button d-block d-md-none">Show Less <i style={{fontSize:"13px"}} class="bi bi-chevron-compact-up"></i></Button>
    </>
  );
};

export default BelowHeaderLeft;