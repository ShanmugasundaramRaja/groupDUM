        ...
        <>
            ...
            <Row>
                <Col xs={12} className="sidebar-container p-0">
                    ...
                    <span className="pl-3 pb-3 text d-flex justify-content-between">Add to your feed <InfoSquareFill style={{fontSize:"18px"}}/> </span>
                    <div className="pl-3 pt-2 pr-3 pb-2">
                        ...
                        <div className="reccomentations d-flex align-items-center justify-content-center">
                            <span>View all recommendations <ArrowRight style={{fontSize:"20px" , fontWeight: "600"}}/> </span>
                        </div>
                    </div>
                    </div>
                </Col>
